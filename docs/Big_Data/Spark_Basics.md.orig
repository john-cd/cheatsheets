...
- [Ampcamp big data bootcamp](https://ampcamp.berkeley.edu/)
- [RDDs Simplified](https://datalakes.com/rdds-simplified/)
...
- [Introduction to Apache Spark with Examples and Use Cases](https://www.hadoop360.com/blog/introduction-to-apache-spark-with-examples-and-use-cases)
