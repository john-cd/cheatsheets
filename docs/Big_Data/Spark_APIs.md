...
```scala
val clickstreamDF = spark.read.format("csv")
  .option("header", "true")
  .option("delimiter", "\\t")
...
clickstreamNoIDs8partDF.createOrReplaceTempView("Clickstream")
spark.cacheTable("Clickstream")
```
...
- [Official Spark Scala API Docs](https://spark.apache.org/docs/latest/api/scala/index.html)
