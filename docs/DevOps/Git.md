...
- [Graphical git cheatsheet](https://byte.kde.org/~zrusin/git/git-cheat-sheet-medium.png)
...
- [Git cheatsheet (interactive)](https://ndpsoftware.com/git-cheatsheet.html#loc=workspace)
