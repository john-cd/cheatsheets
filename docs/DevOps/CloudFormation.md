...
- [AWS CLI cloudformation](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/index.html#cli-aws-cloudformation)
...
- [boto3 cloudformation](https://boto3.readthedocs.io/en/latest/reference/services/cloudformation.html)

## [YAML](https://en.wikipedia.org/wiki/YAML)

- [YAML Cheatsheet](https://lzone.de/cheat-sheet/YAML)
...
[Templates for the US East (Northern Virginia) Region](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cfn-sample-templates-us-east-1.html)
